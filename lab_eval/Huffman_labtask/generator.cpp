...
// 1. Put every character into min-heap.
// 2. Take two lowest-frequency nodes.
// 3. Merge them into one parent node.
// 4. Push parent back.
// 5. Repeat until one root remains.
// 6. Generate codes from root.
...
//name the output file as table.txt
